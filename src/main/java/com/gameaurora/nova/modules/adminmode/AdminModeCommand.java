...
public class AdminModeCommand implements CommandExecutor {
    ...
    private void giveAdminKit(Player player) {
        player.getInventory().setItem(5, getAdminItem(Material.WOOD_AXE, "Admin Wand"));
        player.getInventory().setItem(6, getAdminItem(Material.LEATHER, "Admin Region Tool"));
        player.getInventory().setItem(7, getAdminItem(Material.COMPASS, "Admin Compass"));
        player.getInventory().setItem(8, getAdminItem(Material.WATCH, "Admin Clock"));
