...
public class MenuUtilities {
    ...
    public static void loadIcons() {
        ...
        icons.put("Factions", i);
        descriptions.put("Factions", "Classic Factions: raiding and more!");
    }

    public static void open(Player player) {
        IconMenu menu;
        menu = new IconMenu(ChatColor.DARK_GRAY + "Server Menu", 18, new IconMenu.OptionClickEventHandler() {
            @Override
