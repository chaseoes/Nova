...
public class GeneralUtilities {
    ...
    public static void launchRandomFirework(Location location) {
        ...
        FireworkEffect.Builder builder = FireworkEffect.builder().trail(random.nextBoolean()).flicker(random.nextBoolean());
    ...
    public static String punctuateName(String name) {
        if (name.endsWith("s")) {
            return name + "'";
        }
        return name + "'s";
